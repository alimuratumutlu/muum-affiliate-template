...
export default function Statistics() {
	...
	return (
		<>
			<Head>
				<title>Statistics - Muum Store</title>
				<meta
					name="description"
					content="Statistics about the products in Muum Store."
				/>
			...
			<Container fluid mt={150}>
				<Paper shadow="lg" px="sm" pt="md" pb="sm" mb="lg">
					...
					>
						...
						<List.Item>
							Determining which brand has the highest count.
						</List.Item>
					</List>
				</Paper>
				<Paper shadow="lg" px="sm" pt="md" pb="sm" mb="lg">
					...
					>
						<List.Item>
							Counting the number of unique sizes per brand.
						</List.Item>
						<List.Item>
				...
				<Paper shadow="lg" px="sm" pt="md" pb="sm" mb="lg">
					...
					<Text mb="sm">
						Size “32” is the key point of this question. I have done the
						following steps:
					</Text>
					<List
						spacing="xs"
